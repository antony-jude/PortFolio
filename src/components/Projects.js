...
export const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Professional-grade Open Source Intelligence framework for ethical cybersecurity research. Features async username reconnaissance across 10+ platforms, comprehensive domain reconnaissance with WHOIS lookups, DNS resolution, SSL certificate extraction, IP intelligence, and security posture assessment.",
      imgUrl: projImg2,
    },
    {
      title: "Rail Tracer - IoT Tracking System",
      description: "End-to-end railway component traceability solution featuring AI-driven laser marking for QR codes, mobile/web software platform with real-time tracking, vendor data management, and hybrid batch + individual component tracking for quality assurance and safety compliance.",
      imgUrl: projImg3,
    },
  ];
